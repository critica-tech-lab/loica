    ...
    <div style={{ display: "flex", flexDirection: "column", height: "100%", fontFamily: "var(--font-ui)" }}>
      ...
      {changes.length > 0 && (
        <div style={{ padding: "0.35rem 0.75rem", borderBottom: "1px solid color-mix(in srgb, var(--fg) 8%, transparent)", flexShrink: 0, display: "flex", alignItems: "center", gap: "0.4rem" }}>
          ...
          <button onClick={acceptAll} style={bulkBtn("var(--success)")} title="Accept all changes">✓ All</button>
          <button onClick={rejectAll} style={bulkBtn("var(--danger)")} title="Reject all changes">✗ All</button>
        </div>
      )}
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "0.4rem", marginBottom: "0.35rem" }}>
        <span style={{
          ...
          color: "var(--accent-fg)", fontSize: "0.6rem", fontWeight: 700, userSelect: "none",
        }}>
      ...
      <div style={{
        ...
        background: isInsert ? `color-mix(in srgb, ${color} 10%, transparent)` : isDelete ? "color-mix(in srgb, var(--delete) 8%, transparent)" : "color-mix(in srgb, var(--fg) 5%, transparent)",
      ...
      <div style={{ display: "flex", gap: "0.35rem" }}>
        <button
          ...
          style={cardActionBtn("var(--success)")}
        ...
        <button
          ...
          style={cardActionBtn("var(--danger)")}
