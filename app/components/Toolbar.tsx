...
const ITEMS: Item[] = [
  ...
  { kind: "inline", label: "",      title: "Highlight (Ctrl+Shift+H)", before: "{==",  after: "==}",    style: { color: "var(--color-star)" }, icon: <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M9 11l6 6" /><path d="M4 20l4-1 11-11-3-3-11 11z" /><line x1="14" y1="6" x2="18" y2="10" /></svg> },
  { kind: "sep" },
  // Link
  { kind: "inline", label: "Link",  title: "Link (Ctrl+K)",          before: "__link__",    after: "" },
  { kind: "sep" },
  // Headings
  { kind: "line",   label: "H1",    title: "Heading 1",              prefix: "# ",   style: { fontWeight: 700, fontSize: "var(--text-lg)" } },
  { kind: "line",   label: "H2",    title: "Heading 2",              prefix: "## ",  style: { fontWeight: 700, fontSize: "var(--text-lg)" } },
  { kind: "line",   label: "H3",    title: "Heading 3",              prefix: "### ", style: { fontWeight: 700, fontSize: "var(--text-base)" } },
  { kind: "line",   label: "H4",    title: "Heading 4",              prefix: "#### ", style: { fontWeight: 700, fontSize: "var(--text-sm)" } },
  { kind: "sep" },
  // Lists
  ...
  { kind: "sep" },
  // Block
  { kind: "line",   label: "\u201C\u201D", title: "Blockquote",             prefix: "> ",   style: { fontSize: "var(--text-xl)", fontWeight: 700, lineHeight: 1, opacity: 0.6 } },
  { kind: "sep" },
  // Table
